...
!
! !INTERFACE:
   module fabm_nersc_ecosmo_gmd_2023_25
!
! !DESCRIPTION:
!
...
! !PUBLIC MEMBER FUNCTIONS:
   public type_nersc_ecosmo_gmd_2023_25
!
...
! !PUBLIC DERIVED TYPES:
   type,extends(type_base_model) :: type_nersc_ecosmo_gmd_2023_25
...
!     Model procedures
   ...
   end type type_nersc_ecosmo_gmd_2023_25
!EOP
!-----------------------------------------------------------------------
...
!
! !INPUT PARAMETERS:
   class (type_nersc_ecosmo_gmd_2023_25),intent(inout),target  :: self
...
!
! !INPUT PARAMETERS:
   class (type_nersc_ecosmo_gmd_2023_25),intent(in) :: self
...
! -------------------------------------------------------------------------
   ...
   end module fabm_nersc_ecosmo_gmd_2023_25
