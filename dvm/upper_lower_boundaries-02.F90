                ...
                if (nhours > 23.9_rk) then
                    ...
                    if (parmean0log <= 1.22_rk) then
                        if (food <= 785.72_rk) then
                            if (food <= 569.42_rk) then
                                if (parlog > -19.11_rk) then
                                    upper_presence = 1.0_rk
                                else
                                    upper_presence = 0.0_rk
                                end if
                            else
                                if (parlog > -17.47_rk) then
                                    upper_presence = 1.0_rk
                                else
                                    upper_presence = 0.0_rk
                                end if
                            ...
                            if (food <= 2129.23_rk) then
                                if (parlog > -14.05_rk) then
                                    upper_presence = 1.0_rk
                                else
                                    upper_presence = 0.0_rk
                                end if
                            else
                                if (parlog > -17.48_rk) then
                                    upper_presence = 1.0_rk
                                else
                                    upper_presence = 0.0_rk
                                end if
                        ...
                        if (parmean0log <= 1.61_rk) then
                            if (food <= 597.79_rk) then
                                if (parlog > -16.03_rk) then
                                    upper_presence = 1.0_rk
                                else
                                    upper_presence = 0.0_rk
                                end if
                            else
                                if (parlog > -13.01_rk) then
                                    upper_presence = 1.0_rk
                                else
                                    upper_presence = 0.0_rk
                                end if
                            ...
                            if (food <= 2278.26_rk) then
                                if (parlog > -8.63_rk) then
                                    upper_presence = 1.0_rk
                                else
                                    upper_presence = 0.0_rk
                                end if
                            else
                                if (parlog > -8.13_rk) then
                                    upper_presence = 1.0_rk
                                else
                                    upper_presence = 0.0_rk
                                end if
                    ...
                    ! Calculate possibilities below the upper boundary
                    if (food <= 1345.27_rk) then
                        if (parmean0log <= 1.49_rk) then
                            if (par0log <= 0.91_rk) then
                                if (parlog < -8.22_rk) then
                                    lower_presence = 1.0_rk
                                else
                                    lower_presence = 0.0_rk
                                end if
                            else
                                if (parlog < -9.45_rk) then
                                    lower_presence = 1.0_rk
                                else
                                    lower_presence = 0.0_rk
                                end if
                        ...
                        if (parmean0log <= 1.48_rk) then
                            if (era5 <= 1.04_rk) then
                                if (parlog < -4.84_rk) then
                                    lower_presence = 1.0_rk
                                else
                                    lower_presence = 0.0_rk
                                end if
                            else
                                if (parlog < -6.14_rk) then
                                    lower_presence = 1.0_rk
                                else
                                    lower_presence = 0.0_rk
                                end if
                            ...
                            if (food <= 2265.41_rk) then
                                if (parlog < -2.32_rk) then
                                    lower_presence = 1.0_rk
                                else
                                    lower_presence = 0.0_rk
                                end if
                            else
                                if (parlog < -1.90_rk) then
                                    lower_presence = 1.0_rk
                                else
                                    lower_presence = 0.0_rk
                                end if
...
! Initialize presence variables
                        ...
                        if (parmean0log <= 0.86_rk) then
                            if (nhours <= 12.95_rk) then
                                if (era5 <= 0.07_rk) then
                                    if (parlog > -12.64_rk) then
                                        upper_presence = 1.0_rk
                                    else
                                        upper_presence = 0.0_rk
                                    end if
                                else
                                    if (parlog > -15.54_rk) then
                                        upper_presence = 1.0_rk
                                    else
                                        upper_presence = 0.0_rk
                                    end if
                                ...
                                if (food <= 1373.86_rk) then
                                    if (parlog > -19.39_rk) then
                                        upper_presence = 1.0_rk
                                    else
                                        upper_presence = 0.0_rk
                                    end if
                                else
                                    if (parlog > -16.86_rk) then
                                        upper_presence = 1.0_rk
                                    else
                                        upper_presence = 0.0_rk
                                    end if
                            ...
                            if (food <= 1581.66_rk) then
                                if (era5 <= 0.56_rk) then
                                    if (parlog > -14.57_rk) then
                                        upper_presence = 1.0_rk
                                    else
                                        upper_presence = 0.0_rk
                                    end if
                                else
                                    if (parlog > -16.22_rk) then
                                        upper_presence = 1.0_rk
                                    else
                                        upper_presence = 0.0_rk
                                    end if
                                ...
                                if (food <= 2621.21_rk) then
                                    if (parlog > -14.67_rk) then
                                        upper_presence = 1.0_rk
                                    else
                                        upper_presence = 0.0_rk
                                    end if
                                else
                                    if (parlog > -15.07_rk) then
                                        upper_presence = 1.0_rk
                                    else
                                        upper_presence = 0.0_rk
                                    end if
                        ...
                        ! Calculate possibilities below the upper boundary
                        if (food <= 2386.20_rk) then
                            if (nhours <= 17.37_rk) then
                                if (food <= 567.07_rk) then
                                    if (parlog < -9.60_rk) then
                                        lower_presence = 1.0_rk
                                    else
                                        lower_presence = 0.0_rk
                                    end if
                                ...
                                if (food <= 761.60_rk) then
                                    if (parlog < -10.21_rk) then
                                        lower_presence = 1.0_rk
                                    else
                                        lower_presence = 0.0_rk
                                    end if
                            ...
                            if (era5 <= 1.29_rk) then
                                if (era5 <= 1.01_rk) then
                                    if (parlog < -5.77_rk) then
                                        lower_presence = 1.0_rk
                                    else
                                        lower_presence = 0.0_rk
                                    end if
...
! Initialize presence variables
                        ...
                        ! Calculate possibilities above the lower boundary
                        if (food <= 663.79_rk) then
                            if (era5 <= -8.41_rk) then
                                if (food <= 567.05_rk) then
                                    if (parlog > -13.18_rk) then
                                        upper_presence = 1.0_rk
                                    else
                                        upper_presence = 0.0_rk
                                    end if
                                else
                                    if (parlog > -9.99_rk) then
                                        upper_presence = 1.0_rk
                                    else
                                        upper_presence = 0.0_rk
                                    end if
                                ...
                                if (food <= 567.52_rk) then
                                    if (parlog > -14.60_rk) then
                                        upper_presence = 1.0_rk
                                    else
                                        upper_presence = 0.0_rk
                                    end if
                                else
                                    if (parlog > -12.68_rk) then
                                        upper_presence = 1.0_rk
                                    else
                                        upper_presence = 0.0_rk
                                    end if
                            ...
                            if (food <= 1373.15_rk) then
                                if (era5 <= -1.07_rk) then
                                    if (parlog > -17.80_rk) then
                                        upper_presence = 1.0_rk
                                    else
                                        upper_presence = 0.0_rk
                                    end if
                                else
                                    if (parlog > -19.89_rk) then
                                        upper_presence = 1.0_rk
                                    else
                                        upper_presence = 0.0_rk
                                    end if
                                ...
                                if (nhours <= 16.94_rk) then
                                    if (parlog > -9.79_rk) then
                                        upper_presence = 1.0_rk
                                    else
                                        upper_presence = 0.0_rk
                                    end if
                                else
                                    if (parlog > -12.04_rk) then
                                        upper_presence = 1.0_rk
                                    else
                                        upper_presence = 0.0_rk
                                    end if
